...
class Player():
    ...
    def store_graph(self, output_file='links.json'):
        """Stores graph in file
        
        user can look it up to cheat xD"""
    ...
    def print_neighbours(self, word=''):
        """Prints neighbours of a word (not used in gameplay)"""
    ...
    def print_rules(self, input_file='rules.txt'):
        """Prints rules of the game to user"""
    ...
    def play(self):
        ...
        while True:
            ...
            #Calculating Difference in characters
            ...
            if self.visited[word_ind]:
                ...
                for neighbour in self.graph[word_ind]:
                    if not self.visited[neighbour]:
                        ...
                        #If word has no neighbours left, picking that word
                        #guarantees victory
                        elif cnt == 0:
                            link_cnt = cnt
                            choice = self.words[neighbour]
